...
const Card = ({ title, position, start, end, content, style, location, link }: CardProps) => {
    return (
        <div className="flex flex-col space-y-2 p-6 relative card min-w-[700px] rounded-xl border bg-card z-20 font-semibold m-12 mb-20 font-sans hover:shadow-[0px_0px_30px_5px_rgb(252,163,17)] transition-shadow delay-300 ease-in duration-300">
